...
const Footer = () => {
  return (
    <>
      <footer className="relative z-10 bg-slate-900 pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-[120px] ">
        <div className="container">
          <div className="mx-10 justify-center flex flex-wrap ">
            <div className="w-full  px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 mx-6 w-full">
                <a href="/#" className="mb-6 inline-block max-w-[160px]">
                  <img
                    src= {logo.src}
                    alt="logo"
                    className="max-w-full h-20 hidden dark:block rounded-full"
                  />
                </a>
                <p className="mb-7 text-base text-body-color dark:text-dark-6">
                    24, 1A, Chandi Ghosh Rd, Ashok Nagar, Tollygunge, 
